  ...
  return (
    ...
    >
      ...
      <div className="hidden md:block overflow-x-auto">
        <table className="min-w-full bg-lightGray border border-gray-300 rounded-lg shadow-md mt-4">
          <thead>
          ...
          <tbody className="text-gray-600 text-sm font-light">
            {filteredData.map((item, index) => (
              <tr key={item.id} className={`border-b border-gray-200 hover:bg-greenish ${index % 2 === 0 ? 'bg-lightGray' : 'bg-white'}`}>
                {columns.map((column) => (
