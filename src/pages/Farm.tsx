    ...
    <div className="flex min-h-screen font-sans bg-white relative overflow-x-auto">
        ...
        <nav className="flex-1 overflow-y-auto">
          <ul className="space-y-3 md:space-y-20 mt-4 md:mt-20">
            {[
              ...
              { icon: moduleIcon, label: "Granjas", path: "" },
      ...
      <main className="flex-1 p-6 lg:ml-0">
        ...
        {loading ? (
          ...
          <>
            {/* Desktop advice's table  */}
			<div className="hidden md:block border border-gray-300 rounded-lg p-1 shadow-md w-full max-w-7xl mx-auto animate-square-in-hesitate">
  <TableWithActions
    data={farms}
    error={error}
    limit={limit}
